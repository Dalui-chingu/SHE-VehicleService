                    ...
                    <div className="row">
                        ...
                        <div className="col-md-4 col-sm-4 col-xs-12">
                            ...
                            <div className="form-group">
                                ...
                                <h6 className="bfont">We'll never share your email with anyone else.</h6>
                            </div>
                            <div className="form-group">
                                ...
                                <h6 className="bfont">*Password length must be atleast 7. Password must contain atleast one number,alphabet and special character</h6>
                            </div>
                            <div className="form-group">
